/**
 * Source text adapted from Common Paper's Mutual NDA (Version 1.0),
 * https://github.com/CommonPaper/Mutual-NDA, licensed under CC BY 4.0
 * (https://creativecommons.org/licenses/by/4.0/). Bracketed/checkbox
 * fill-ins and coverpage cross-references have been replaced with
 * `{{token}}` placeholders for programmatic completion.
 */

export const COVER_PAGE_TEMPLATE = `# Mutual Non-Disclosure Agreement

*This document is a draft generated for convenience and is not legal advice. It should be reviewed by a qualified attorney before use.*
...
export const STANDARD_TERMS_TEMPLATE = `## Standard Terms

1. **Introduction**. This Mutual Non-Disclosure Agreement (which incorporates these Standard Terms and the Cover Page (defined above)) ("**MNDA**") allows each party ("**Disclosing Party**") to disclose or make available information in connection with the {{purpose}} which (1) the Disclosing Party identifies to the receiving party ("**Receiving Party**") as "confidential", "proprietary", or the like or (2) should be reasonably understood as confidential or proprietary due to its nature and the circumstances of its disclosure ("**Confidential Information**"). Each party's Confidential Information also includes the existence and status of the parties' discussions and information on the Cover Page. Confidential Information includes technical or business information, product designs or roadmaps, requirements, pricing, security and compliance documentation, technology, inventions and know-how. To use this MNDA, the parties must complete and sign a cover page incorporating these Standard Terms ("**Cover Page**"). Each party is identified on the Cover Page and capitalized terms have the meanings given herein or on the Cover Page.
...
5. **Term and Termination**. This MNDA commences on the {{effectiveDate}} and expires at the end of the {{mndaTermPhrase}}. Either party may terminate this MNDA for any or no reason upon written notice to the other party. The Receiving Party's obligations relating to Confidential Information will survive for {{confidentialityTermPhrase}}, despite any expiration or termination of this MNDA.
